...
public class DynamicCom {
    ...
    final static String RULE_CLASS_NAME = "dynamicCompiler.p6.NameRule";

    final static String RULE_SOURCE = "package dynamicCompiler.p6;\n" +
            "\n" +
            ...
            "        System.out.println(1234567818839L);\n" +
            "        return false;\n" +
            "    }\n" +
            "}\n";
    ...
    public static void main(String[] args) throws Exception {
        ...
        byteClassLoader.putClass("dynamicCompiler.p2.Dog", IOUtils.toByteArray(new FileInputStream("/Users/getui/Desktop/compiler/classes/dynamicCompiler/p2/Dog.class")));

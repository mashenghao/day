...
public class ItemDriver2 {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
        ...
        // 2 指定本程序的jar包所在的本地路径
        job.setJarByClass(ItemDriver2.class);

        // 3 指定本业务job要使用的Mapper/Reducer业务类
        job.setMapperClass(ItemMapper2.class);
        job.setReducerClass(ItemReducer2.class);
    ...
    private static class ItemMapper2 extends Mapper<LongWritable, Text, Text, Item> {
        ...
        protected void setup(Context context) throws IOException, InterruptedException {
            ...
            FSDataInputStream in = fs.open(new Path("D:\\tmp\\pd.txt"));
    ...
    private static class ItemReducer2 extends Reducer<Text, Item, Text, Item> {
